...
def get_info_sp():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"URL  "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"METHODS GET/POST  "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    methods = input()
...
def get_info_gold():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"URL  "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    gtarget = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"WORKER 5-500  "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTGREEN_EX)
    gworkers = input()
    return gtarget, gworkers
    ...
    if command == "cls" or command == "clear":
        ...
        special()
            ...
            try:
                ...
                print('Example: low http://target.com GET')
            ...
            try:
                gtarget, gworkers = get_info_gold()
                os.system(f'cd resources && python3 goldeneye.py {gtarget} -w {gworkers}')
            except IndexError:
                print('Usage: golden URL WORKERS')
                print('Example: golden http://target.com -w 10')
